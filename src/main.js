...
Vue.use(Button).use(Field).use(Dialog).use(Loading).use(NavBar).use(Overlay)
  ...
  .use(Notify).use(RadioGroup).use(Radio).use(ImagePreview).use(SwipeCell).use(DatetimePicker ).use(Skeleton).use(Grid).use(GridItem).use(Progress).use(Picker).use(Stepper).use(slider)
