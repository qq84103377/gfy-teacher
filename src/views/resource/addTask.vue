<template>
  <section class="add-task">
    ...
    <div class="add-task__body">
      ...
      <van-cell class="add-task__body__cell"
                v-if="['lesson','material','exam'].includes($route.query.type)||($route.query.taskType=='T01'||$route.query.taskType=='T03'||($route.query.taskType=='T04'&&$route.query.testPaperId!=0))">
        <div slot="title">
          <div class="add-task__body__cell-ctn"
