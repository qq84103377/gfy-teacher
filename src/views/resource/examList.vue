<template>
  <section class="exam-list">
    ...
    <van-popup v-model="addExam.show" position="bottom">
      <div class="exam-pop">
        ...
        <van-cell v-if="addExam.title != '复制'" class="exam-pop__cell">
          <div slot="title" class="aic">
            ...
            <van-radio-group style="display: flex;" v-model="addExam.share">
              ...
              <van-radio name="S03"><i slot="icon" slot-scope="props" :class="['iconGFY','icon-radio-active',{'radio-normal':!props.checked}]"></i>
                公开
              </van-radio>
            </van-radio-group>
          </div>
