<template>
  <div class="feedbackDetail">
        ...
        <div v-if="showAsk" class="ask-agin" >
          <van-cell-group>
            <van-field
              v-model="desc"
              type="textarea"
              placeholder="请输入您遇到的问题或建议（请填写10个字以上的问题描述以便我们提供更好的帮助）！"
              rows="5"
              autosize
            />
          </van-cell-group>
    ...
    <div class="askbtn" v-if="!score">
      <div
        v-if="!(['S07','S08','S09'].includes($route.query.status))"
        @click="handleAsk"
        style="color: #39F0DD;background: #fff;"
      >{{showAsk?'取消':'继续提问'}}
      </div>
      <div
        v-if="!(['S07','S08','S09'].includes($route.query.status))"
      ...
      <div class="body">
        <div class="ques" style="display:flex;">
          ...
          <van-radio-group
            ...
            v-model="appraiseData.problemSolved"
          >
        ...
        <div class="comment">
          ...
          <div
            ...
            :key="item"
            class="icon-flower"
            :class="{actived: appraiseData.evaluationScore >= item}"
