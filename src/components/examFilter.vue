    ...
    <div class="exam-filter-wrap">
      ...
      <div class="exam-filter-wrap__header van-hairline--bottom">
        <div class="exam-filter-wrap__header-tab">
          <span>选择试卷</span>
          <van-icon class="icon-close" @click="show=false;shareType=''" name="close" />
        </div>
      </div>
      ...
      <div class="exam-filter-wrap__footer">
        <van-button type="info" class="confirm-btn" @click="show=false;shareType='';chooseTestPaper()">确定</van-button>
      </div>
    </div>
  </van-popup>
</template>
